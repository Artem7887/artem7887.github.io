...
function getPixabayJson(word, counter) {
  ...
  url = 'http://pixabay.com/api/?key=3855363-37ef90f3cb6002adb9b962fb2&q=background&image_type=illustration' + word + '&limit=' + counter;
  } else {
  url = 'https://pixabay.com/api/?key=3855363-37ef90f3cb6002adb9b962fb2&q=background&image_type=illustration' + word + '&limit=' + counter;
  }
